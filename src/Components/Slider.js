...
const CardSliderComponent = () => {
  ...
  return (
    <div style={{ backgroundColor: "black", width: "100%", paddingLeft: "0.5%", paddingRight: "1%" }}>
      <Carousel {...carouselSettings} className="carousel-container">
        {Card.map((card) => (
          <div className="Slider carousel-container custom-dot-list" key={card.title}>
            <img className='CardImage'
              ...
              alt={""}
              style={{ width: "40%", height: "40%", borderRadius: "50%", backgroundColor: "yellow" }}
            />
      ...
      {/* <style jsx>{`
        ...
        .CarouselCard .react-multi-carousel-list {
          margin: 0;
          padding: 0;
        }
        .custom-dot-list {
